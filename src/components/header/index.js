...
const Header = props => {
  ...
  return <div className="d-flex header-block border-bottom align-items-center px-4">
    <div className="col-5 px-0">
      <Search /> 
    </div> 
    <div className="d-flex col-7 pr-5 justify-content-end align-items-center">
      <div className="notifications mr-2 cursor-pointer">
        <span className="notification-badge badge-danger"></span>
        <NotificationIcon className="icon-sm"/>
      </div>
      <SettingsIcon className="icon-sm mr-2 cursor-pointer" />
      <UserProfile />
    </div>
  </div>
};
